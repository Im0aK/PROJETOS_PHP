...
<body>
    <div class="container-home">
        ...
        <?php
            ...
            <a href="logout.php"> <img src="icons/porta.png.png" width="50px" height="50px"></a>
        </div>
        ...
        <div class="menu">
            ...
            <a href="usuario-cadastro.php"><spam class="tooltiptext">CADASTRAR USUMÁRIO</spam><img src="icons/user-add.png"></a>
